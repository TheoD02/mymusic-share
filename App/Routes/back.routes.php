...
$router->map('GET', '/admin-panel/categories-list', NAMESPACE_BACKOFFICE . 'AdminCategoriesManagementController@showCategoriesList', 'adminCategoriesList');
 ...
 */
$router->map('GET', '/admin-panel/artists-list', NAMESPACE_BACKOFFICE . 'AdminArtistsManagementController@showArtistsList', 'adminArtistsList');
 ...
 */
$router->map('GET', '/admin-panel/users-list', NAMESPACE_BACKOFFICE . 'AdminUsersManagementController@listUsers', 'adminUsersList');
 ...
 */
$router->map('GET', '/admin-panel/musics-list', NAMESPACE_BACKOFFICE . '\AdminMusicsManagementController@showMusicList', 'adminMusicsList');
$router->map('GET', '/admin-panel/pending-musics-list', NAMESPACE_BACKOFFICE . '\AdminMusicsManagementController@showPendingMusicsList', 'adminPendingMusicsList');
/** Ajouter une musique */
 ...
 * Liste des commandes
 */
$router->map('GET', '/admin-panel/orders-list', NAMESPACE_BACKOFFICE . '\AdminOrdersManagementController@showOrdersList', 'adminOrdersList');