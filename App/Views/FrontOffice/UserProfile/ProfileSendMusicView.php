...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>Téléversement d'un fichier MP3</h1>
            <form action="<?= AltoRouter::getRouterInstance()->generate('profileSendMusic') ?>" method="post" id="musicForm" enctype="multipart/form-data">
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-floating my-3 col-md-3 col-sm-6">
                                        <select name="id_musicKey" id="id_musicKey"
                                                class="form-control  <?= FormValidator::fieldIsValid('id_musicKey') ?>">
                                            <option value="default" selected disabled>
                                    ...
                                    <div class="form-floating my-3 col-md-3 col-sm-6">
                                        <select name="id_categories" id="id_categories"
                                                class="form-control  <?= FormValidator::fieldIsValid('id_categories') ?>">
                                            <option value="default" selected disabled>
                                    ...
                                    <div class="form-group my-3">
                                        <input type="submit" class="btn btn-secondary" value="Confirmer l'ajout du fichier audio"
                                               name="uploadMusicAction">
                                    </div>
                                </div>
                            </div>
                        </div>
